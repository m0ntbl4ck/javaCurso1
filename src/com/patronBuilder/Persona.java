...
public class Persona {
    ...
    public String toString() {
        return "Persona{" + "nombre=" + nombre + ", apellidos=" + apellidos + ", documentoIdetidad=" + documentoIdetidad + ", email=" + email + ", telefono=" + telefono + ", fechaDeNacimiento=" + fechaDeNacimiento + ", genero=" + genero + ", estadoCivil=" + estadoCivil + '}';
    }
