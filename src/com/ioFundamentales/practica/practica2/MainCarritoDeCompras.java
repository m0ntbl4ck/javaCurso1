...
public class MainCarritoDeCompras {
    ...
    public static void main(String[] args) {
        ...
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("archivos//carrito.ser"))) {
        ...
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("archivos//carrito.ser"))) {
