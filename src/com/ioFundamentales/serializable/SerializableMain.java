...
public class SerializableMain {
    public static void main(String[] args) {
        ...
        try (ObjectOutputStream salida = new ObjectOutputStream(new FileOutputStream("archivos//persona.ser"))) {
        ...
        try (ObjectInputStream entrada = new ObjectInputStream(new FileInputStream("archivos//persona.ser"))) {
